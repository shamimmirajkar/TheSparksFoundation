...
if($result->num_rows>0)
{
    ...
    <tr>
        <td><?php echo (isset($row['c_id']) ? $row['c_id'] : ''); ?></td>
        <td><?php echo (isset($row['c_name']) ? $row['c_name'] : ''); ?></td>
        <td><?php echo (isset($row['c_mail']) ? $row['c_mail'] : ''); ?></td>
        <td><?php echo (isset($row['c_balance']) ? $row['c_balance'] : ''); ?></td>
        <td ><a id=btn href="transfermoney.php?c_id=<?php echo $row['c_id']; ?>">Money Transfer </a></td>
